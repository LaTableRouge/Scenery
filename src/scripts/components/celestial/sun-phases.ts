import { type Observer,SearchAltitude, SearchHourAngle, SearchRiseSet } from 'astronomy-engine'
...
const sunFormatTime = (date: Date): number => {
...
export const sunPhases = (observer: Observer): void => {
